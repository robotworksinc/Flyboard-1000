...
// #define MIN_PULSE_WIDTH      1050
// #define DEFAULT_PULSE_WIDTH  1050
#define MIN_PULSE_WIDTH       950     // the shortest pulse sent to a servo  
#define MAX_PULSE_WIDTH      1750     // the longest pulse sent to a servo 
